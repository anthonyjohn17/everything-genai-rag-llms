...
# Explain OpenClaw (`everything-openclaw/explain-openclaw/`)

> **Folder:** [`everything-openclaw/explain-openclaw/`](https://github.com/anthonyjohn17/everything-genai-rag-openclaw/tree/main/everything-openclaw/explain-openclaw) · Monorepo: [`everything-genai-rag-openclaw`](https://github.com/anthonyjohn17/everything-genai-rag-openclaw)  
> Beginner + technical guide (formerly Moltbot / Clawdbot naming in upstream).
