...
<p><sub><strong>Folder:</strong> <code>everything-openclaw/openclaw-usecases/</code> · Monorepo: <a href="https://github.com/anthonyjohn17/everything-genai-rag-openclaw">everything-genai-rag-openclaw</a></sub></p>
</div>

# OpenClaw use cases (`everything-openclaw/openclaw-usecases/`)
...
> **Warning:** OpenClaw skills and third-party dependencies referenced here may have critical security vulnerabilities. Many use cases link to community-built skills, plugins, and external repos that have **not been audited for this copy under `everything-openclaw/openclaw-usecases/`**. Always review skill source code, check requested permissions, and avoid hardcoding API keys or credentials. You are solely responsible for your own security.
