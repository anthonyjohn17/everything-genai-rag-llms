# Skills (`everything-openclaw/openclaw-agents/skills/`)

> **Path:** `everything-openclaw/openclaw-agents/skills/` in [`everything-genai-rag-openclaw`](https://github.com/anthonyjohn17/everything-genai-rag-openclaw).
