# Ollama configs (`everything-openclaw/openclaw-agents/configs/ollama/`)

> **Path:** `everything-openclaw/openclaw-agents/configs/ollama/` in [`everything-genai-rag-openclaw`](https://github.com/anthonyjohn17/everything-genai-rag-openclaw).
