...
[![Skills](https://img.shields.io/badge/skills-5198-blue?style=flat-square)](#table-of-contents)
[![Portfolio](https://img.shields.io/badge/Portfolio-anthonyjohn17-181717?logo=github&style=flat-square)](https://github.com/anthonyjohn17/everything-genai-rag-openclaw)

**Indexed OpenClaw / ClawHub skills.** **Folder:** [`everything-openclaw/openclaw-skills/`](https://github.com/anthonyjohn17/everything-genai-rag-openclaw/tree/main/everything-openclaw/openclaw-skills) · Monorepo: [`everything-genai-rag-openclaw`](https://github.com/anthonyjohn17/everything-genai-rag-openclaw). Curated by [John Anthony](https://github.com/anthonyjohn17).

</div>

# OpenClaw skills index (`everything-openclaw/openclaw-skills/`)
...
OpenClaw agents can interact with external services like GitHub, Slack, Gmail, and more. Build integrations with **skills** and **plugins**, and follow the **[official OpenClaw documentation](https://docs.openclaw.ai)** for authentication patterns and security guidance.
...
If you believe a skill in this list should be flagged or has a security concern, please [open an issue](https://github.com/anthonyjohn17/everything-genai-rag-openclaw/issues) on this monorepo so it can be reviewed.
...
> **Portfolio fork:** Contact for this snapshot goes through [the monorepo issues](https://github.com/anthonyjohn17/everything-genai-rag-openclaw/issues).
...
If you find an issue with a listed skill or want your skill removed, please [open an issue](https://github.com/anthonyjohn17/everything-genai-rag-openclaw/issues) on this monorepo.
