# OpenClaw Mission Control (`everything-openclaw/openclaw-mission-control/`)

[![Portfolio](https://img.shields.io/badge/Curator-anthonyjohn17-181717?logo=github)](https://github.com/anthonyjohn17/everything-genai-rag-openclaw)

This copy is vendored under **`everything-openclaw/openclaw-mission-control/`** in [**everything-genai-rag-openclaw**](https://github.com/anthonyjohn17/everything-genai-rag-openclaw). Upstream CI and Slack below refer to the **original** Mission Control project.
