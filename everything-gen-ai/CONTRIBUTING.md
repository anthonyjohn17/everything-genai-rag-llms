...
**Scope:** changes under [`everything-gen-ai/`](https://github.com/anthonyjohn17/everything-genai-rag-openclaw/tree/main/everything-gen-ai) in monorepo **`everything-genai-rag-openclaw`**.
...
A project may be included in the [Main List](https://github.com/anthonyjohn17/everything-genai-rag-openclaw/blob/main/everything-gen-ai/README.md) if it fulfills at least one of the following criteria:
...
2. **Personally interesting to the curator**: The project should be of particular interest to the curator of this list. This may include innovative approaches, niche applications, or projects that showcase unique capabilities in the realm of generative AI.

Please make sure that your suggested project meets at least one of these criteria before [submitting](https://github.com/anthonyjohn17/everything-genai-rag-openclaw/pulls) it for inclusion in the Main List.
...
The Discoveries list is an inclusive and vibrant collection of projects that demonstrate the diversity and creativity within the Generative AI community. If you have a project, service, or resource related to Generative AI that you would like to share, feel free to submit it through a [pull request](https://github.com/anthonyjohn17/everything-genai-rag-openclaw/pulls).
